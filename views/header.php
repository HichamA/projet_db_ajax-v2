	...
	<nav class="navbar navbar-pills">
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      ...
	      <form class="navbar-form navbar-right" method="get" action="list.php">
	        <div class="form-group">
	          <input type="text" class="form-control" placeholder="Recherche" name="q" value="<?= isset($_GET['$search'])? $search : ''; ?>">
	        </div>
